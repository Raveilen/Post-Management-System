...
namespace PostManagementSystem.Controllers
{
    public class StatusController : Controller
    {
        ...
        public StatusController(PostManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> GetImage(Guid? id)
        {
            ...
            return File(status.Image, "image/jpg");
        }
        ...
        public async Task<IActionResult> Create([Bind("StatusID,Name,Image")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("StatusID,Name,Image")] Status status)
        {
