...
namespace PostManagementSystem.Data
{
    public class DbInitializer
    {
        ...
        public static void Seed(PostManagementContext context)
        {
            ...
            {
                new Address { 
                    Street = "Nowy Świat", DwellingNumber = "18",
                    ApartmentNumber = "12",
                    PostalCode = "00-372",
                ...
                new Address { 
                    ...
                    DwellingNumber = "20", PostalCode = "70-531",
                ...
                new Address { 
                    ...
                    ApartmentNumber = "11", PostalCode = "42-200",
            ...
            var statuses = new Status[]
            {
                new Status { 
                    Name = "Ordered",
                    Image = ImageConverter.ConvertImageToByteArray("~/assets/img/Ordered.png") },
                new Status { 
                    Name = "Packed",
                    Image = ImageConverter.ConvertImageToByteArray("~/assets/img/Packed.png") },
                new Status { 
                    Name = "In Transit",
                    Image = ImageConverter.ConvertImageToByteArray("~/assets/img/InTransit.png") },
                new Status { 
                    Name = "Delivered", 
                    Image = ImageConverter.ConvertImageToByteArray("~/assets/img/Delivered.png") },
                new Status { 
                    Name = "Collected",
                    Image = ImageConverter.ConvertImageToByteArray("~/assets/img/Collected.png")},
                new Status {
                    Name = "Returned",
                    Image = ImageConverter.ConvertImageToByteArray("~/assets/img/Returned.png") }
            };
            ...
            var packageTypes = new PackageType[]
            {
                new PackageType { 
                    ...
                    Image = ImageConverter.ConvertImageToByteArray("~/assets/img/Small.png") },
                new PackageType { 
                    Name = "Medium",
                    MaxWeight = 25,
                    MaxDimensions = "19x38x64",
                    IsFragile = false, Cost = 18.99m,
                    Image = ImageConverter.ConvertImageToByteArray("~/assets/img/Medium.png") },
                new PackageType { 
                    Name = "Large",
                    MaxWeight = 25,
                    ...
                    IsFragile = false,
                    Cost = 20.99m,
                    Image = ImageConverter.ConvertImageToByteArray("~/assets/img/Large.png") },
